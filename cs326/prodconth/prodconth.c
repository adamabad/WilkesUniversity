...
// Author: Adam Abad
// Date: 10/31/19
// Program Name: Multiple prod/con with threads, mutexes, and condition
//   variables.
//******************************************************************

/* Description:
    Prodconth.c uses the pthread library and it's functions to recreate
    the producer/consumer system with 2 producers and 2 consumers. 
    The threads share a globaly initilized 10-integer buffer. The  
    producers use a shared variable called current to keep track
    of the current value being produced and the consumers use a 
    shared variable called position that indicated what part of the
    buffer they are reading from.
*/
