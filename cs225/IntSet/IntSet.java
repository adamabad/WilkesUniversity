...
public class IntSet {
	...
	else if (s2 == null) return null;
	else if (s1.element == s2.element)
	    return new IntSet(s1.element, intersection(s1.next, s2.next));
	else if (s1.element > s2.element)
	    return intersection(s1, s2.next);
	else if (s1.element < s2.element)
	    return intersection(s1.next, s2);
	else return intersection(s1.next, s2.next);
    }
	...
	else if (s1 == null) return null;
	else if (s1.element == s2.element)
	    return difference(s1.next, s2.next);
	else if (s1.element < s2.element)
	...
	if (s1 == null) return true;
	    ...
	    return isSubsetOf(s1.next, s2.next);
	else if (s1.element > s2.element)
	...
	if (s == null) return "";
	if (s.next == null)
	    return s.element + toString(s.next);
	else return s.element + "," + toString(s.next);
    }
