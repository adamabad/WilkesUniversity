...
// Assignment 4
//
// Uses a modified linked list to implement circular lists.
// Follows all functions useable by linked list advanced, including
// copying and adding through files.
// 
// I have tested my code and it work properly.
//******************************************************************

//******************************************************************
// Driver program for Circular lists that can handle copying and
// file manipulation.
// Uses a cirular list to order data.
//******************************************************************

//******************************************************************
// Main driver program for testing listc.cpp
// Uses a Circular list to order input data.
//******************************************************************
...
void header() {
  cout<<"\nName: Adam Abad\n";
  cout<<"Circular List\n";
  cout<<"Uses a cicularly singly linked list to order data from files.\n\n";
}
